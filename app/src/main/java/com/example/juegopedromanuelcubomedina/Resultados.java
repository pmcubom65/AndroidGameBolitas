...
public class Resultados extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table resultado (fecha text, puntuacion text, tiempo text, juego text, ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, unique(fecha,puntuacion))");
